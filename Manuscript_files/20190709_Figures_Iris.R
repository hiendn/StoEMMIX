...
# Open a plot device
pdf(file='./Iris2.pdf',width=12,height=4,paper='special') 
...
# Open a plot device
pdf(file='./Iris2timing.pdf',width=12,height=4,paper='special') 
...
# Open a plot device
pdf(file='./Iris2SE.pdf',width=12,height=4,paper='special') 
...
# Open a plot device
pdf(file='./Iris2ARI.pdf',width=12,height=4,paper='special') 
