...
for (rr in 1:Rep) {
  ...
  # Save and print outputs
  save(Results,file='./Quin2.rdata')
  print(c(rr,Results[rr,]))
  save(Timing,file='./Quin2timing.rdata')
  save(ARI_results,file='./Quin2ARI.rdata')
  save(SE_results,file='./Quin2SE.rdata')
  print(c(rr,Timing[rr,]))
  print(c(rr,ARI_results[rr,]))
  print(c(rr,SE_results[rr,]))
  
  # Also sink results to a text file
  sink('./Quin2.txt',append = TRUE)
  cat(rr,Results[rr,],'\n')
  sink()
  sink('./Quin2timing.txt',append = TRUE)
  cat(rr,Timing[rr,],'\n')
  sink()
  sink('./Quin2ARI.txt',append = TRUE)
  cat(rr,ARI_results[rr,],'\n')
  sink()
  sink('./Quin2SE.txt',append = TRUE)
  cat(rr,SE_results[rr,],'\n')
  sink()
}