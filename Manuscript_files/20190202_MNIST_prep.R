...
# load labels
train_label = as.factor(load_label_file("./train-labels-idx1-ubyte"))
test_label  = as.factor(load_label_file("./t10k-labels-idx1-ubyte"))

# Combine the data
combined <- rbind(train,test)

# Assess sparseness
sparse <- sum(colSums(combined)==0)

# Obtain a dense data set
dense <- combined[,-which(colSums(combined)==0)]
